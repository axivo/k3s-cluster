...
The role performs various tasks related to `victoria-metrics-k8s-stack` [chart](https://github.com/VictoriaMetrics/helm-charts/tree/victoria-metrics-k8s-stack-0.31.0/charts/victoria-metrics-k8s-stack) deployment, reset and validation.
...
| victoriametrics_vars.kubernetes.helm.chart.version | string | `"v0.31.0"` |  |

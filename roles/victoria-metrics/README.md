...
| victoriametrics_vars.kubernetes.vmagent.resources.limits.memory | string | `"704Mi"` |  |
| victoriametrics_vars.kubernetes.vmagent.resources.requests.cpu | string | `"10m"` |  |
| victoriametrics_vars.kubernetes.vmagent.resources.requests.memory | string | `"704Mi"` |  |

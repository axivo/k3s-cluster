...
![Version: 9.5.14](https://img.shields.io/badge/Version-9.5.14-informational?style=flat-square)

The role performs various tasks related to `argo-cd` [chart](https://github.com/argoproj/argo-helm/tree/argo-cd-9.5.14/charts/argo-cd) deployment, reset and validation. Review the [documentation](https://axivo.com/k3s-cluster/wiki/guide/configuration/roles/argocd), for additional details.
...
|------------|------|---------|
| https://github.com/argoproj/argo-cd | argocd | 3.3.7 |
...
| argocd_vars.kubernetes.helm.chart.version | string | `"v9.5.14"` | Helm chart version |
...
| argocd_vars.release.version | string | `"v3.3.7"` | CLI version to install |

...
| argocd_vars.kubernetes.helm.chart.version | string | `"v7.7.7"` |  |
...
| argocd_vars.kubernetes.server.infrastructure.loadbalancer | string | Set value into [all.yaml](../../inventory/cluster/group_vars/all.yaml) `infrastructure` collection | `CiliumLoadBalancerIPPool` address, set at global level |

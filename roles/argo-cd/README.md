...
> [!TIP]
> - Use [Renovate](https://axivo.com/k3s-cluster/tutorials/handbook/renovate/), to automate release pull requests and keep dependencies up-to-date
...
| argocd_vars.kubernetes.helm.chart.version | string | `"v7.7.11"` |  |

...
![Version: 1.32.4+k3s1](https://img.shields.io/badge/Version-1.32.4+k3s1-informational?style=flat-square)

The role performs various tasks related to `k3s` [cluster](https://github.com/k3s-io/k3s/releases/tag/v1.32.4+k3s1) deployment, reset and validation. Review the [documentation](https://axivo.com/k3s-cluster/wiki/guide/configuration/roles/k3s), for additional details.
...
| k3s_vars.release.k3s.version | string | `"v1.32.4+k3s1"` |  |

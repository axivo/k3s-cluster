...
![Version: 7.8.13](https://img.shields.io/badge/Version-7.8.13-informational?style=flat-square)
...
|------------|------|---------|
| https://github.com/argoproj/argo-cd | argocd | 2.14.7 |
...
| argocd_vars.release.version | string | `"v2.14.7"` |  |

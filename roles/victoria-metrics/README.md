...
The role performs various tasks related to `victoria-metrics-k8s-stack` [chart](https://github.com/VictoriaMetrics/helm-charts/tree/victoria-metrics-k8s-stack-0.33.2/charts/victoria-metrics-k8s-stack) deployment, reset and validation.

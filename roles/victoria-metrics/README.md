...
|------------|------|---------|
| https://prometheus-community.github.io/helm-charts | prometheus-operator-crds | 25.0.1 |
...
| victoriametrics_vars.kubernetes.helm.chart.prometheus.version | string | `"v25.0.1"` |  |

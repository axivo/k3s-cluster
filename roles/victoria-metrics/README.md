...
|------------|------|---------|
| https://prometheus-community.github.io/helm-charts | prometheus-operator-crds | 24.0.1 |
...
| victoriametrics_vars.kubernetes.helm.chart.prometheus.version | string | `"v24.0.1"` |  |

...
![Version: 1.47.0](https://img.shields.io/badge/Version-1.47.0-informational?style=flat-square)

The role performs various tasks related to `coredns` [chart](https://github.com/coredns/helm/tree/coredns-1.47.0/charts/coredns) deployment, reset and validation. Review the [documentation](https://axivo.com/k3s-cluster/wiki/guide/configuration/roles/coredns), for additional details.
...
| coredns_vars.kubernetes.helm.chart.version | string | `"v1.47.0"` |  |

...
| metricsserver_vars.kubernetes.namespace | string | `"kube-system"` | See [documentation](https://google.github.io/glog/stable/logging/#verbose-logging), for details |
...
| metricsserver_vars.kubernetes.server.args | list | `["--v=1"]` | Additional server arguments, set log level verbosity |

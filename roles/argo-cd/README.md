...
![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![Version: 7.7.22](https://img.shields.io/badge/Version-7.7.22-informational?style=flat-square)

The role performs various tasks related to `argo-cd` [chart](https://github.com/argoproj/argo-helm/tree/argo-cd-7.7.22/charts/argo-cd) deployment, reset and validation. Review the [documentation](https://axivo.com/k3s-cluster/wiki/guide/configuration/roles/argocd), for additional details.
...
|------------|------|---------|
| https://github.com/argoproj/argo-cd | argocd | 2.13.4 |
...
| argocd_vars.kubernetes.helm.chart.version | string | `"v7.7.22"` |  |
...
| argocd_vars.release.version | string | `"v2.13.4"` |  |

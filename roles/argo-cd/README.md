...
See the related role variables listed below, defined into [main.yaml](./defaults/main.yaml) defaults file. Advanced user variables are defined into [facts.yaml](./tasks/facts.yaml) task file.

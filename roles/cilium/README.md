...
The role performs various tasks related to `cilium` [chart](https://github.com/cilium/cilium/tree/v1.17.1/install/kubernetes/cilium) deployment, reset and validation. Review the [documentation](https://axivo.com/k3s-cluster/wiki/guide/configuration/roles/cilium), for additional details.
...
|------------|------|---------|
| https://github.com/cilium/cilium-cli | cilium-cli | 0.18.0 |
...
| cilium_vars.kubernetes.helm.chart.version | string | `"v1.17.1"` |  |
...
| cilium_vars.release.cli.version | string | `"v0.18.0"` |  |

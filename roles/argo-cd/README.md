...
![Version: 9.4.17](https://img.shields.io/badge/Version-9.4.17-informational?style=flat-square)

The role performs various tasks related to `argo-cd` [chart](https://github.com/argoproj/argo-helm/tree/argo-cd-9.4.17/charts/argo-cd) deployment, reset and validation. Review the [documentation](https://axivo.com/k3s-cluster/wiki/guide/configuration/roles/argocd), for additional details.
...
|------------|------|---------|
| https://github.com/argoproj/argo-cd | argocd | 3.3.2 |
...
| argocd_vars.kubernetes.helm.chart.version | string | `"v9.4.17"` | Helm chart version |

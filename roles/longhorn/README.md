...
The role performs various tasks related to `longhorn` [chart](https://github.com/longhorn/charts/tree/longhorn-1.11.2/charts/longhorn) deployment, reset and validation. Review the [documentation](https://axivo.com/k3s-cluster/wiki/guide/configuration/roles/longhorn), for additional details.
...
|------------|------|---------|
| https://github.com/longhorn/cli | longhornctl | 1.11.1 |
...
| longhorn_vars.kubernetes.helm.chart.version | string | `"v1.11.2"` |  |
...
| longhorn_vars.release.version | string | `"v1.11.1"` |  |

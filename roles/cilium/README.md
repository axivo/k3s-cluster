...
The role performs various tasks related to `cilium` [chart](https://github.com/cilium/cilium/tree/v1.19.3/install/kubernetes/cilium) deployment, reset and validation. Review the [documentation](https://axivo.com/k3s-cluster/wiki/guide/configuration/roles/cilium), for additional details.
...
| https://github.com/cilium/hubble | hubble | 1.19.3 |
| https://github.com/kubernetes-sigs/gateway-api | gateway-api | 1.5.1 |
...
| cilium_vars.kubernetes.helm.chart.version | string | `"v1.19.3"` |  |
...
| cilium_vars.release.gateway_api.version | string | `"v1.5.1"` |  |
...
| cilium_vars.release.hubble.version | string | `"v1.19.3"` |  |

...
![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![Version: 1.30.6+k3s1](https://img.shields.io/badge/Version-1.30.6+k3s1-informational?style=flat-square)

The role performs various tasks related to the `k3s` [cluster](https://github.com/k3s-io/k3s/releases/tag/v1.30.6+k3s1) deployment, reset and validation.
...
| k3s_vars.release.k3s.version | string | `"v1.30.6+k3s1"` |  |

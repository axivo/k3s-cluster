...
The role performs various tasks related to `cert-manager` [chart](https://github.com/cert-manager/cert-manager/tree/v1.19.4/deploy/charts/cert-manager) deployment, reset and validation. Review the [documentation](https://axivo.com/k3s-cluster/wiki/guide/configuration/roles/certmanager), for additional details.
...
|------------|------|---------|
| https://github.com/cert-manager/cmctl | cmctl | 2.4.1 |
...
| certmanager_vars.kubernetes.helm.chart.version | string | `"v1.19.4"` |  |
...
| certmanager_vars.release.file | string | `"cmctl_linux_{{ global_map.cpu_architecture.short }}"` | See [documentation](https://axivo.com/k3s-cluster/tutorials/handbook/server/#hardware), for details |
| certmanager_vars.release.repository.name | string | `"cmctl"` |  |
| certmanager_vars.release.repository.org | string | `"cert-manager"` |  |
| certmanager_vars.release.version | string | `"v2.4.1"` |  |
